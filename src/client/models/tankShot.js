...
// document.addEventListener("DOMContentLoaded", function(){
    function initGame(){
        ...
        // var originalPoints = [[0, 280], [100, 280], [200, 50], [380, 280], [800, 280],
        // [800, 500],[0, 500],[0, 280]];

        var originalPoints = [[0, 280], [100, 280], [200, 200], [380, 280], [800, 280],
        [800, 500],[0, 500],[0, 280]];

        // var originalPoints = [[0, 280],[800, 280],
        // [800, 500],[0, 500],[0, 280]];
        ...
        const drawTankFn = (xCoordinate, yCoordinate, angleWeapon) => {
            ...
            return (xCoordinate, yCoordinate, angleWeapon) => {
                ...
                angle_second = tiltTank(xCoordinate);
                ctx.save();
                if (angle_second > 0) {
                    var angle_curr = angle_second / Math.PI * 180;
                ...
                else if (angle_second > angleWeapon){
                    var angleWeapon_curr = angleWeapon / Math.PI * 180;
                    angleWeapon_curr = Math.round(angleWeapon_curr / 10);
                    yCof =yCof + (angleWeapon_curr * 6.5);
                }
